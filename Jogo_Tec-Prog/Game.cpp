...
Game::Game() {
	Entities::Characters::Player* p1 = new Entities::Characters::Player(Math::CoordF(650,200), true, &movingEntities);
	//Entities::Characters::Player* p2 = new Entities::Characters::Player(Math::CoordF(850, 200), false, &movingEntities);
	//Entities::Characters::Zombie* z1 = new Entities::Characters::Zombie(Math::CoordF(200, 200));
	...
	Entities::Obstacles::Simple* floor = new Entities::Obstacles::Simple(Math::CoordF(960, 1070), Math::CoordF(1920, 10));
